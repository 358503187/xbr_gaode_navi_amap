...
public class BaseNaviActivity extends Activity implements AMapNaviListener, AMapNaviViewListener, ParallelRoadListener {
    ...
    protected NaviLatLng mEndLatlng =  new NaviLatLng(39.917337, 116.397056);
    protected NaviLatLng mStartLatlng = new NaviLatLng(39.993266, 116.473193);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            mAMapNavi.getNaviSetting();
            mAMapNavi.setTrafficInfoUpdateEnabled(true);
...
//        mAMapNavi.stopNavi();
    ...
    protected void onDestroy() {
        ...
        //since 1.6.0 不再在view destroy的时候自动执行AMapNavi.stopNavi();请自行执行
        if (mAMapNavi != null) {
            mAMapNavi.stopNavi();
            AMapNavi.destroy();
        }
