...
public interface ILocationHelperServiceAIDL extends android.os.IInterface
{
  ...
  {
    private static final String DESCRIPTOR = "com.yilin.xbr.xbr_gaode_navi_amap.ILocationHelperServiceAIDL";
    ...
    /**
     * Cast an IBinder object into an com.yilin.xbr.xbr_gaode_navi_amap.ILocationHelperServiceAIDL interface,
